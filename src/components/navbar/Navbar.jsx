...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="font-poppins menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        <li><a>Products</a></li>
        <li><a>Business</a></li>
    ...
    <ul className="menu menu-horizontal px-1 text-white">
      <li><a className='font-poppins'>Products</a></li>
      <li><a className='font-poppins'>Business</a></li>
      <li><a className='font-dm-sans'>What We Do</a></li>
    </ul>
  </div>
  </div>
