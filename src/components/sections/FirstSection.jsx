...
const FirstSection = () => {
  return (
    <div className="lg:h-screen w-screen pb-5 lg:pb-0 lg:mb-40 bg-customBlue px-20">
      <Navbar />
      <div className="flex flex-col lg:flex-row mt-20">
        ...
        <div className="flex mt-20 lg:mt-0 ml-32 flex-1 lg:flex-auto flex-col lg:w-2/5 text-white">
          <div className="relative">
            ...
            <div class="absolute top-[-3rem] right-10 p-3 bg-white text-black shadow-md rounded-lg w-300 h-103.21">
              <div className="flex relative">
                <div className="flex flex-col">
                  <div className="font-normal font-inter text-12.98">
                    Card Balance
                  </div>
                  <div className="font-semibold font-dm-sans text-31.16 text-[#121212]">
                    &#x20A6;32,804,000
                  </div>
                </div>
            ...
            <div class="absolute top-28 left-[-10rem] p-3 bg-white text-black shadow-md rounded-lg w-300 h-103.21">
              <div className="flex relative">
                <div className="flex flex-col">
                  ...
                  <div className="font-semibold font-dm-sans text-31.16">
                    &#x20A6;32,804,000
                  </div>
                </div>
            ...
            <div class="absolute bottom-9 right-10 px-3 py-5 bg-white text-black shadow-md rounded-lg w-300 h-103.21">
              <div className="flex relative justify-between">
                ...
                <div className="flex flex-col ml-10">
                  <div className="font-semibold font-dm-sans text-20">
                    Spotify
                  </div>
                  <div className="font-normal font-inter text-12.98">
                    Yesterday, 5:30 PM
                ...
                <div className="font-bold font-public-sans text-[15.58px] pt-4">
                  &#x20A6;32,804,000
                </div>
              </div>
            </div>
