...
const FirstSection = () => {
  return (
    <div className="h-screen w-screen bg-customBlue px-20">
      <Navbar />
      <div className="flex flex-col lg:flex-row mt-20">
        <div className="flex mr-10 flex-1 lg:flex-auto flex-col lg:w-3/5 text-white">
          <div>
            <p className="font-semibold text-custom-size text-custom-height">
              One App, all your Financial Needs
            </p>
          </div>
          <div>
            <p className="font-normal leading-40px">
        ...
        <div className="flex ml-32 flex-1 lg:flex-auto flex-col lg:w-2/5 text-white">
          ...
          <div class="absolute top-[-3rem] right-10 p-3 bg-white text-black shadow-md rounded-lg w-300 h-103.21">
            <div className="flex relative">
               ...
               <div className="font-normal text-12.98">Card Balance</div>
               <div className="font-semibold text-31.16">&#x20A6;32,804,000</div>
               </div>
          ...
          <div class="absolute top-28 left-[-10rem] p-3 bg-white text-black shadow-md rounded-lg w-300 h-103.21">
            <div className="flex relative">
               <div className="flex flex-col">
               <div className="font-normal text-12.98">Total Earnings</div>
               <div className="font-semibold text-31.16">&#x20A6;32,804,000</div>
               </div>
          ...
          <div class="absolute bottom-9 right-10 p-3 bg-white text-black shadow-md rounded-lg w-300 h-103.21">
            <div className="flex relative justify-between">
               ...
               <div className="font-semibold text-20">Spotify</div>
               <div className="font-normal text-12.98">Yesterday, 5:30 PM</div>
               </div>

            
               <div className="font-bold text-12.98 pt-6">&#x20A6;32,804,000</div>
