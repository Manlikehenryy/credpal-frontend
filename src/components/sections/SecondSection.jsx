...
const SecondSection = () => {
  return (
    <div className="mx-auto lg:mb-48 font-poppins mb-32 px-5 md:px-0 w-full md:max-w-[min(1330px,calc(100%-1rem))] md:w-[83.125rem] ">
      <div className="mt-20">
          ...
          <div className="flex flex-row gap-6 pb-10">
              ...
              <div className="flex flex-col">
                ...
                <div className="mx-2 mt-4">
                  <p className="text-14">
                    ...
                    breeze to save regularly, and the investment options are
            ...
            <div className="relative bg-[#F9FAFB] flex flex-col flex-shrink-0 gap-4 p-8 w-[min(24rem,100%)]">
              <div className="flex flex-col">
                ...
                <div className="mx-2 mt-4">
                  <p className="text-14">
                    "I never thought investing could be so simple and
                    accessible, but this app has changed my mind. I can invest
                    easily track my portfolio's performance. Highly recommend
            ...
            <div className="relative bg-[#F9FAFB] flex flex-col flex-shrink-0 gap-4 p-8 w-[min(24rem,100%)]">
              <div className="flex flex-col">
                ...
                <div className="mx-2 mt-4">
                  <p className="text-14">
                    "I've been using this app for months now and it has
                    completely changed the way I manage my finances. The app is
                    user-friendly, offers great investment options, and has
                    helped me save more money than I ever thought was possible."
                  </p>
                </div>
