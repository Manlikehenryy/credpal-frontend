...
const SeventhSection = () => {
  return (
    <div className="lg:h-screen w-screen mb-10 lg:mb-20 mt-[-6rem]">
      <div className="w-full items-center justify-center flex-col lg:flex-row flex overflow-hidden">
        <div className="relative mb-5 p-6 mr-4 bg-customOrange text-black shadow-md rounded-lg w-352 h-400">
          <div className="flex flex-col">
            ...
            <div className="mt-12 font-dm-sans font-bold text-32">
              Move with CredPal
            </div>
          ...
          <div className="flex flex-col">
            <div className="relative mx-2">
              <div className="absolute top-0.5 left-5">
                <img src="/icon-2b.png" alt="" />
              </div>
              <img src="/icon-2a.png" alt="" />
            </div>

            <div className="mt-12 font-bold text-32 font-dm-sans">
              Travel with CredPal
            </div>
