...
const ThirdSection = () => {
  return (
    <div className="h-screen w-screen mb-80 lg:mb-0">
  ...
  <div className="flex mb-16 lg:mb-0 justify-center lg:items-start items-center flex-col w-full lg:w-2/4">
    <div className="font-bold font-dm-sans text-48 mb-4  text-customTextColor">Payments</div>
    ...
    <div className="mt-10">
      <button className="btn bg-customBtnBlue font-dm-sans text-white rounded-none w-256">Download App</button>
    </div>
  </div>
